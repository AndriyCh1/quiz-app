...
const userQuizzesService = new UserQuizzesService(apiConfig.baseUrl, apiConfig.http);

export { authService, storageService, userService, visitorQuizzesService, userQuizzesService };
